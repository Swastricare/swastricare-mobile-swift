    ...
    override fun Content() {
        ...
        Column(
            ...
            Text(
                text = "${currentMl}ml",
                style = TextStyle(
                    color = ColorProvider(day = android.graphics.Color.parseColor("#64D2FF"), night = android.graphics.Color.parseColor("#64D2FF")),
                    fontWeight = FontWeight.Bold,
                    fontSize = 28.sp
                )
            )
            ...
            Row(
                ...
                Box(
                    modifier = GlanceModifier
                        .cornerRadius(8.dp)
                        .background(ColorProvider(day = android.graphics.Color.parseColor("#1A64D2FF"), night = android.graphics.Color.parseColor("#3364D2FF")))
