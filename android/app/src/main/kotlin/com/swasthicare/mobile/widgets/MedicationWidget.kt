        ...
        Column(
            ...
            if (nextTime.isNotBlank()) {
                Text(
                    text = nextTime,
                    style = TextStyle(
                        color = ColorProvider(day = android.graphics.Color.parseColor("#5E5CE6"), night = android.graphics.Color.parseColor("#5E5CE6")),
            ...
            if (medicationId.isNotBlank()) {
                ...
                Box(
                    modifier = GlanceModifier
                        .fillMaxWidth()
                        .cornerRadius(8.dp)
                        .background(ColorProvider(day = android.graphics.Color.parseColor("#1A32D74B"), night = android.graphics.Color.parseColor("#3332D74B")))
                    ...
                    Text(
                        text = "Mark as Taken",
                        style = TextStyle(
                            color = ColorProvider(day = android.graphics.Color.parseColor("#32D74B"), night = android.graphics.Color.parseColor("#32D74B")),
                            fontWeight = FontWeight.Bold,
                            fontSize = 13.sp
                        )
                    )
