...
struct WorkoutActivityAttributes: ActivityAttributes {
    ...
    // MARK: - Content State (dynamic, updates over time)
    ...
    public struct ContentState: Codable, Hashable {
        ...
        // MARK: - Convenience formatting (used by widget UI)
        ...
        var formattedCurrentPace: String { formatPace(currentPaceSecondsPerKm) }
        var formattedAveragePace: String { formatPace(averagePaceSecondsPerKm) }
